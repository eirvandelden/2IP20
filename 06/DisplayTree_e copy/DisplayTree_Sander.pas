...
{OWNCODEADDED}
  ...
  with ACanvas do begin
    ...
    rectangle(Anode.fwidth - ANode.FX, ANode.FHeight -  ANode.FY, Anode.FWidth, Anode.FHeight);
//
//      MessageDlg(IntToStr(ANode.FX), mtconfirmation, [mbok],  0 );
//      MessageDlg(IntToStr(ANode.Fy) , mtconfirmation, [mbok],  0 );
//      MessageDlg( IntToStr(ANode.Fwidth), mtconfirmation, [mbok],  0 );
//      MessageDlg(IntToStr(ANode.Fheight), mtconfirmation, [mbok],  0 );
