...
begin
  ...
  // als dit een linkerparent is óf er moeten lege nodes worden gemaakt, moeten we de coordinaten vaststellen
  if (TreeWidth(ANode.FRight) > 0) or (TreeWidth(ANode.FLeft) > 0) then begin     // aan een van beide kanten
    ...
    case FRootPositionStyle of                                       // De x-positie van de Node, afhankelijk van orientatie
      0: begin
      ...
      2: begin
        ...
        // als dit geen parent is of geen lege nodes moet hebben (dus alle andere gevallen)
  end //if
  else begin
