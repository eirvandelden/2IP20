...
var
   BDrawTrees: Boolean;       // hulp var voor bij het tekenen van de lege trees
...
begin
  ...
  if (LeftWidth = 0) and (RightWidth = 0) then begin     // als we alleen lege, niet te tekenen nodes hebben
      ...
      Anode.FHeight := Max(LeftHeight, RightHeight) + FVSpace + (2 * FNodeSize); //de hoogte is de max van de linker óf rechter hoogte, met de VSpace en de Node size
  end; //else
